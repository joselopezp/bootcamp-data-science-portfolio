...
| **Short-term** | Validar pipeline en entorno cloud (Google Colab o Databricks Community) para demostrar escalabilidad.
Conexión con PBI |
| **Long-term** | Integrar datos reales de clickstream + implementar modelo BG/NBD para predicción de lifetime value. Conectar con PequeShop prescriptive analytics arc. |
