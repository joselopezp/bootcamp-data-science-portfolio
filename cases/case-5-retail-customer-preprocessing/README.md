# Eliminating Silent Model Bias: Preprocessing Pipeline for Customer Classification
### Retail Customer Analytics — Imputation, Encoding & Feature Scaling | CRISP-DM + LEAN
