# Revealing Hidden Customer Segments: PCA vs t-SNE on 2,240 Real Customers
### Marketing Campaign Targeting — Customer Personality Analytics | CRISP-DM + LEAN
...
```
case-customer-segment-discovery/
│
├── README.md                          # This file
├── notebooks/
...
# Navigate to case
cd cases\case-customer-segment-discovery

# Launch notebook
jupyter lab notebooks\case_customer_segment_discovery.ipynb
```
