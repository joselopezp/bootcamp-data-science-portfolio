# 66% Fewer Features, Same Diagnostic Power: PCA vs t-SNE for Clinical ML Pipelines
### Dimensionality Reduction — DataMed Analytics, Neurological Early Diagnosis | CRISP-DM + LEAN
